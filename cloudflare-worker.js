...
if (!team && mode === "currentweek") {
    ...
    if (!team && mode === "top25") {
      ...
      try {
        ...
        // Every game that has ACTUALLY finished, not just games from
        // strictly-prior weeks -- the Colley rating used to freeze at
        // the same weekly cadence as the AP poll (only updating once
        // "week" itself advanced), when it should genuinely update as
